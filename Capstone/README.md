...
6. Deployment: <font color="red"><i>Outside the scope of the capstone project</i></font>
...
7. Monitoring: <font color="red"><i>Outside the scope of the capstone project</i></font>
